...
# Soccer league. Init with text file of league results. Instance method process_league_results parses
# the text file and prints to std out the top three teams in the league standings after each matchday
class League
